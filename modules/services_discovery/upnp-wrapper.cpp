...
UpnpInstanceWrapper *UpnpInstanceWrapper::get(vlc_object_t *p_obj)
{
    ...
    if ( s_instance == NULL )
    {
        ...
        if( (i_res = UpnpSetWebServerRootDir( "/home/johan/projects/vlc/vlc.git/web" )) != UPNP_E_SUCCESS)
        {
            msg_Err( p_obj, "UpnpSetWebServerRootDir failed: %s",
                    UpnpGetErrorMessage( i_res ));
            delete instance;
            return NULL;
        }
        ...
        {
            msg_Err( p_obj, "UpnpEnableWebserver failed: %s",
                    UpnpGetErrorMessage( i_res ));
            delete instance;
            return NULL;
        }
